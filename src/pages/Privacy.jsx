      ...
      <div role="banner" className="w-full bg-card border-b border-border shadow-sm">
        ...
        <nav aria-label="Primary navigation" className="w-full px-6 py-2 overflow-x-auto">
          <div className="max-w-4xl mx-auto flex gap-x-4 sm:gap-x-6 gap-y-1 text-sm font-medium whitespace-nowrap sm:whitespace-normal">
            ...
            <Link to="/contact" className="inline-block py-1 px-0.5 text-foreground/70 hover:text-primary transition-colors">Contact</Link>
            <Link to="/privacy" className="inline-block py-1 px-0.5 text-foreground hover:text-primary transition-colors">Privacy</Link>
